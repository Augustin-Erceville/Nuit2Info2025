...
<section class="container">
    <div class="card text-center text-light border-light bg-transparent">
        ...
        <div class="card-body">
            <form action="../../src/treatment/treatmentConnexion.php" method="post">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control text-light bg-transparent" id="floatingInput" placeholder="name@example.com">
                    <label for="floatingInput">Identifiant de connexion</label>
                </div>
                <div class="form-floating">
                    <input type="password" class="form-control text-light bg-transparent" id="floatingPassword" placeholder="Password" autocomplete="new-password">
                    <label for="floatingPassword">Mot de passe</label>
                </div>
                <div class="row g-2 my-3">
                    <div class="col">
                        <button type="submit" class="btn btn-lg w-100 bg-primary text-light">
                            Se connecter
                        </button>
                    </div>
                </div>
