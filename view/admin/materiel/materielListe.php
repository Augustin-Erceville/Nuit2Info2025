    ...
    <div class="container-fluid position-relative">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <div class="ms-auto d-none d-lg-flex align-items-center">
                ...
                <a href="../materiel/materielListe.php" class="btn btn-outline-danger active btn-lg me-2"
            ...
            <ul class="navbar-nav ms-auto d-lg-none mt-3 w-100">
                ...
                <li class="nav-item mb-2">
                    <a class="btn btn-outline-danger active w-100" href="../materiel/materielListe.php">
                        <i class="bi bi-pc-display"></i>
                        Matériels
                    </a>
                </li>
