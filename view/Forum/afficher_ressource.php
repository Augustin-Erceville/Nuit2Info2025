...
// 3. Récupérer les commentaires de cette ressource
...
// Limiter à 5 commentaires racine (les plus récents déjà triés DESC)
if (isset($tree[null])) {
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($ressource['titre']); ?> – Ressource</title>
    <style>
        body {
            margin: 0;
        ...
        /* Modal pour ajouter un commentaire général sur cette ressource */
...
<header class="top-nav">
    <div class="nav-left">
        <a href="liste_ressources.php" class="nav-logo">Forum Ressources</a>
    </div>
    <div class="nav-right">
...
<!-- MODAL AJOUTER COMMENTAIRE RACINE SUR CETTE RESSOURCE -->
